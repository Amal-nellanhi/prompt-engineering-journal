...
### Accuracy Score by Prompt Version

This line plot visualizes the average **Accuracy Score** across all models, demonstrating the immediate improvement achieved by implementing detailed constraints (V3).

<img src="img/accuracy-plot.png" alt="Line chart showing accuracy increase from V1 to V3" width="700" />

### Overall Performance Improvement (+41%)

The chart below compares the overall average score (out of 5.0) for each prompt version, highlighting the **41% total improvement** achieved by the highly specific V3 prompt.

<img src="img/overall-improvement-plot.png" alt="Bar chart comparing overall average scores for V1, V2, and V3" width="700" />
...
### Grading Methodology
The scores assigned in the evaluation tables (Clarity, Accuracy, Tone, etc.) represent subjective human evaluation against objective criteria defined in the [Evaluation Criteria page](evaluation-criteria.md). They are not automatically generated by AI tools.

### Coincidence Clause
Any resemblance of the product, company names, or content generated to real-world entities is purely coincidental. This project is for educational and experimental purposes only.